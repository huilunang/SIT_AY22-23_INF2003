...
(17, 'Paper', 'Paper packaging / Printed paper box / Paper Box', 'YES', 'Please flatten'),
(18, 'Paper', 'Egg tray', 'YES', ''),
(19, 'Paper', 'Beverage carton (e.g. milk, juice and drink packet)', 'YES', 'Please empty and rinse when necessary. Please flatten'),
(20, 'Paper', 'Paper towel and toilet roll tube', 'YES', ''),
(21, 'Paper', 'Tissue box', 'YES', 'Please flatten'),
(22, 'Paper', 'Paper bag', 'YES', ''),
(23, 'Paper', 'Paper disposables such as Paper cup, Paper plate, Glitter paper, Crayon drawing', 'NO', 'Dispose as general waste'),
(24, 'Paper', 'Tissue paper', 'NO', 'Dispose as general waste'),
(25, 'Paper', 'Paper towel', 'NO', 'Dispose as general waste'),
(26, 'Paper', 'Toilet paper', 'NO', 'Dispose as general waste'),
(27, 'Paper', 'Disposable wooden chopstick / Wooden chopsticks / Pizza boxes', 'NO', 'Dispose as general waste'),
(28, 'Paper', 'Wax paper', 'NO', 'Dispose as general waste'),
(29, 'Paper', 'Paper packaging that are contaminated with food (eg pizza box, paper bag for pastries)', 'NO', 'Dispose as general waste'),
(30, 'Cardboard', 'Carton box / Cardboard box', 'YES', 'Please flatten'),
...
(17, 'PAPER', 'PAPER PACKAGING PRINTED PAPER BOX PAPER BOX', 'Please flatten before recycling', ''),
(18, 'PAPER', 'EGG TRAYS', 'Make sure it is clean before recycling', ''),
(19, 'PAPER', 'BEVERAGE CARTON: Milk carton / Drink packet / Juice packet', 'Please empty, rinse and flatten before recycling', ''),
(20, 'PAPER', 'PAPER TOWEL TUBE TOILET ROLL TUBE', 'Make sure it is clean before recycling', ''),
(21, 'PAPER', 'TISSUE BOX', 'Please flatten before recycling', ''),
(22, 'PAPER', 'PAPER BAG', 'Make sure it is clean before recycling', ''),
(23, 'PAPER', 'PAPER DISPOSABLES: Paper cup / Paper plate / Glitter paper / Crayon drawing', '', 'Dispose as general waste'),
(24, 'PAPER', 'TISSUE PAPER', '', 'Dispose as general waste'),
(25, 'PAPER', 'PAPER TOWEL', '', 'Dispose as general waste'),
(26, 'PAPER', 'TOILET PAPER', '', 'Dispose as general waste'),
(27, 'PAPER', 'DISPOSABLE WOODEN CHOPSTICKS / WOODEN CHOPSTICKS / PIZZA BOXES', '', 'Dispose as general waste'),
(28, 'PAPER', 'WAX PAPER', '', 'Dispose as general waste'),
(29, 'PAPER', 'PAPER PACKAGING CONTAMINATED WITH FOOD', '', 'Dispose as general waste'),
(30, 'CARDBOARD', 'CARTON BOX CARDBOARD BOX', 'Please flatten before recycling', ''),
